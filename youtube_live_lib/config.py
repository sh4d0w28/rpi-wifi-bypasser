...
RELAY_LISTENER_LOG_PATH = Path(os.environ.get("YOUTUBE_RELAY_LISTENER_LOG_PATH", "/run/rpi_ap_tools_youtube_listener.log"))
...
PROXY_INGRESS_LOGLEVEL = os.environ.get("YOUTUBE_PROXY_INGRESS_LOGLEVEL", "info").strip() or "info"
...
RELAY_TRANSFER_STALE_SEC = max(5.0, float(os.environ.get("YOUTUBE_RELAY_TRANSFER_STALE_SEC", "20.0") or "20.0"))
ZMQ_REQ = 3
ZMQ_LINGER = 17
ZMQ_RCVTIMEO = 27
ZMQ_SNDTIMEO = 28
